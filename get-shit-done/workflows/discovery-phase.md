...
See __GSD_PATH__get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using __GSD_PATH__get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using __GSD_PATH__get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from __GSD_PATH__get-shit-done/templates/discovery.md
...
Use __GSD_PATH__get-shit-done/templates/discovery.md.
