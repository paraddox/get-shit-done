...
```bash
INIT=$(node "__GSD_HOME_PATH__get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "__GSD_HOME_PATH__get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "__GSD_HOME_PATH__get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "__GSD_HOME_PATH__get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
