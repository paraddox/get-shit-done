...
<!-- For checkpoint task examples and patterns, see @__GSD_PATH__get-shit-done/references/checkpoints.md -->
...
See `__GSD_PATH__get-shit-done/references/tdd.md` for TDD plan structure.
...
See `__GSD_PATH__get-shit-done/templates/user-setup.md` for full schema and examples
...
See `__GSD_PATH__get-shit-done/workflows/verify-phase.md` for verification logic.
